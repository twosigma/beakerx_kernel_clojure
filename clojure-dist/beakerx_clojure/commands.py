...
import argparse
import sys
import beakerx_clojure
from notebook import notebookapp as app
from .install import install, uninstall


def install_subparser(subparser):
    install_parser = subparser.add_parser('install', help='installs BeakerX Clojure Kernel extensions')
...
def uninstall_subparser(subparser):
    uninstall_parser = subparser.add_parser('uninstall', help='uninstalls BeakerX Clojure Kernel extensions')
...
def init_parser():
    ...
    parser.add_argument('--version', action='version', version=beakerx_clojure.__version__)
